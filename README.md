...
### Five reasons to use this package:
  ...
  - **Flexibility**,[&#x2197;](docs/source/framework-doc.md#haplodynamicsframeworkmodel) with the ability to mix your own models with the framework to create custom simulations.
